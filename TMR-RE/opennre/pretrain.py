...
def download_wiki80(root_path=default_root_path):
    check_root()
    if not os.path.exists(os.path.join(root_path, 'data/wiki80')):
        os.mkdir(os.path.join(root_path, 'data/wiki80'))
        os.system('wget -P ' + os.path.join(root_path, 'data/wiki80') + ' ' + root_url + 'opennre/data/wiki80/wiki80_rel2id.json')
        os.system('wget -P ' + os.path.join(root_path, 'data/wiki80') + ' ' + root_url + 'opennre/data/wiki80/wiki80_train.txt')
        os.system('wget -P ' + os.path.join(root_path, 'data/wiki80') + ' ' + root_url + 'opennre/data/wiki80/wiki80_val.txt')

def download_tacred(root_path=default_root_path):
    check_root()
    if not os.path.exists(os.path.join(root_path, 'data/tacred')):
        os.mkdir(os.path.join(root_path, 'data/tacred'))
        os.system('wget -P ' + os.path.join(root_path, 'data/tacred') + ' ' + root_url + 'opennre/data/tacred/tacred_rel2id.json')
...
def download_nyt10(root_path=default_root_path):
    check_root()
    if not os.path.exists(os.path.join(root_path, 'data/nyt10')):
        os.mkdir(os.path.join(root_path, 'data/nyt10'))
        os.system('wget -P ' + os.path.join(root_path, 'data/nyt10') + ' ' + root_url + 'opennre/data/nyt10/nyt10_rel2id.json')
        os.system('wget -P ' + os.path.join(root_path, 'data/nyt10') + ' ' + root_url + 'opennre/data/nyt10/nyt10_train.txt')
        os.system('wget -P ' + os.path.join(root_path, 'data/nyt10') + ' ' + root_url + 'opennre/data/nyt10/nyt10_test.txt')
        os.system('wget -P ' + os.path.join(root_path, 'data/nyt10') + ' ' + root_url + 'opennre/data/nyt10/nyt10_val.txt')

def download_wiki_distant(root_path=default_root_path):
    check_root()
    if not os.path.exists(os.path.join(root_path, 'data/wiki_distant')):
        os.mkdir(os.path.join(root_path, 'data/wiki_distant'))
        os.system('wget -P ' + os.path.join(root_path, 'data/wiki_distant') + ' ' + root_url + 'opennre/data/wiki_distant/wiki_distant_rel2id.json')
        os.system('wget -P ' + os.path.join(root_path, 'data/wiki_distant') + ' ' + root_url + 'opennre/data/wiki_distant/wiki_distant_train.txt')
        os.system('wget -P ' + os.path.join(root_path, 'data/wiki_distant') + ' ' + root_url + 'opennre/data/wiki_distant/wiki_distant_test.txt')
        os.system('wget -P ' + os.path.join(root_path, 'data/wiki_distant') + ' ' + root_url + 'opennre/data/wiki_distant/wiki_distant_val.txt')

def download_semeval(root_path=default_root_path):
    check_root()
    if not os.path.exists(os.path.join(root_path, 'data/semeval')):
        os.mkdir(os.path.join(root_path, 'data/semeval'))
        os.system('wget -P ' + os.path.join(root_path, 'data/semeval') + ' ' + root_url + 'opennre/data/semeval/semeval_rel2id.json')
        os.system('wget -P ' + os.path.join(root_path, 'data/semeval') + ' ' + root_url + 'opennre/data/semeval/semeval_train.txt')
        os.system('wget -P ' + os.path.join(root_path, 'data/semeval') + ' ' + root_url + 'opennre/data/semeval/semeval_test.txt')
        os.system('wget -P ' + os.path.join(root_path, 'data/semeval') + ' ' + root_url + 'opennre/data/semeval/semeval_val.txt')
...
def get_model(model_name, root_path=default_root_path):
    ...
    if model_name == 'wiki80_cnn_softmax':
        ...
        rel2id = json.load(open(os.path.join(root_path, 'data/wiki80/wiki80_rel2id.json')))
        ...
        rel2id = json.load(open(os.path.join(root_path, 'data/tacred/tacred_rel2id.json')))
        if 'entity' in model_name:
            sentence_encoder = encoder.BERTEntityEncoder(
                max_length=80, pretrain_path=os.path.join(root_path, 'pretrain/bert-base-uncased'))
        else:
