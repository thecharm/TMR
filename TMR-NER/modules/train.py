...
class NERTrainer(BaseTrainer):
    ...
    def _step(self, batch, mode="train"):
        ...
        input_ids, token_type_ids, attention_mask, labels, images, aux_imgs, images_dif, aux_imgs_dif, weight, input_ids_g, token_type_ids_g, attention_mask_g = batch
        output = self.model(input_ids=input_ids, attention_mask=attention_mask,
                            labels=labels, images=images, aux_imgs=aux_imgs, images_dif=images_dif,
                            aux_images_dif=aux_imgs_dif, weight=weight, input_ids_phrase=input_ids_g,
